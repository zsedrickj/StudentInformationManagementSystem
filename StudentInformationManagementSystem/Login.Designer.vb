...
Partial Class Login
    ...
    Private Sub InitializeComponent()
        ...
        Label3.Location = New Point(135, 359)
        Label3.Name = "Label3"
        ...
        Label2.Location = New Point(135, 307)
        Label2.Name = "Label2"
        ...
        ' lnkSignUp
        ' 
        lnkSignUp.ActiveLinkColor = Color.RoyalBlue
        lnkSignUp.AutoSize = True
        lnkSignUp.LinkColor = Color.FromArgb(CByte(244), CByte(245), CByte(252))
        lnkSignUp.Location = New Point(629, 320)
        lnkSignUp.Name = "lnkSignUp"
        lnkSignUp.Size = New Size(146, 20)
        lnkSignUp.TabIndex = 7
        lnkSignUp.TabStop = True
        lnkSignUp.Text = "Create an account"
        ' 
        ' btnLogin
        ' 
        ...
        PictureBox1.Size = New Size(291, 215)
