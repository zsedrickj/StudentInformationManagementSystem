...
Partial Class ProgramForm
    ...
    Private Sub InitializeComponent()
        ...
        CType(dgvProgram, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' Panel3
        ' 
        ...
        Panel3.Controls.Add(dgvProgram)
        ...
        dgvProgram.Location = New Point(72, 106)
        dgvProgram.Name = "dgvProgram"
        dgvProgram.RowHeadersWidth = 51
        dgvProgram.Size = New Size(902, 266)
        dgvProgram.TabIndex = 2
        ' 
        ' Label8
        ' 
        ...
        CType(dgvProgram, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
    End Sub
